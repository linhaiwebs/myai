...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with AsymiLink AI
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('AsymiLink AI - AI Coding Studio', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by AsymiLink AI', margin, doc.internal.pageSize.getHeight() - 10);
